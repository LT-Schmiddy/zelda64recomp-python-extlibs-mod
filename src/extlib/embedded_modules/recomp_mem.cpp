...
PYBIND11_EMBEDDED_MODULE(_recomp_mem_managed, m, py::mod_gil_not_used(), py::multiple_interpreters::per_interpreter_gil()) {
    ...
    m.def("read_u8", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        uint8_t val;
        memcpy_rev_from_recomp(t_controller->get_rdram(), &val, ptr, sizeof(uint8_t));
        return py::int_(val);
    });
    ...
    m.def("write_u8", [](int32_t ptr, py::int_ obj){
        ...
        memcpy_rev_to_recomp(t_controller->get_rdram(), ptr, &val, sizeof(uint8_t));
    });
    ...
    m.def("read_u16", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        uint16_t val;
        memcpy_rev_from_recomp(t_controller->get_rdram(), &val, ptr, sizeof(uint16_t));
        return py::int_(val);
    });
    ...
    m.def("write_u16", [](int32_t ptr, py::int_ obj){
        ...
        memcpy_rev_to_recomp(t_controller->get_rdram(), ptr, &val, sizeof(uint16_t));
    });
    ...
    m.def("read_u32", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        uint32_t val;
        memcpy_rev_from_recomp(t_controller->get_rdram(), &val, ptr, sizeof(uint32_t));
        return py::int_(val);
    });
    ...
    m.def("write_u32", [](int32_t ptr, py::int_ obj){
        ...
        memcpy_rev_to_recomp(t_controller->get_rdram(), ptr, &val, sizeof(uint32_t));
    });
    ...
    m.def("read_u64", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        uint64_t val;
        memcpy_rev_from_recomp(t_controller->get_rdram(), &val, ptr, sizeof(uint64_t));
        return py::int_(val);
    });
    ...
    m.def("write_u64", [](int32_t ptr, py::int_ obj){
        ...
        memcpy_rev_to_recomp(t_controller->get_rdram(), ptr, &val, sizeof(uint64_t));
    });
    ...
    m.def("read_s8", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        int8_t val;
        memcpy_rev_from_recomp(t_controller->get_rdram(), &val, ptr, sizeof(int8_t));
        return py::int_(val);
    });
    ...
    m.def("write_s8", [](int32_t ptr, py::int_ obj){
        ...
        memcpy_rev_to_recomp(t_controller->get_rdram(), ptr, &val, sizeof(int8_t));
    });
    ...
    m.def("read_s16", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        int16_t val;
        memcpy_rev_from_recomp(t_controller->get_rdram(), &val, ptr, sizeof(int16_t));
        return py::int_(val);
    });
    ...
    m.def("write_s16", [](int32_t ptr, py::int_ obj){
        ...
        memcpy_rev_to_recomp(t_controller->get_rdram(), ptr, &val, sizeof(int16_t));
    });
    ...
    m.def("read_s32", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        int32_t val;
        memcpy_rev_from_recomp(t_controller->get_rdram(), &val, ptr, sizeof(int32_t));
        return py::int_(val);
    });
    ...
    m.def("write_s32", [](int32_t ptr, py::int_ obj){
        ...
        memcpy_rev_to_recomp(t_controller->get_rdram(), ptr, &val, sizeof(int32_t));
    });
    ...
    m.def("read_s64", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        int64_t val;
        memcpy_rev_from_recomp(t_controller->get_rdram(), &val, ptr, sizeof(int64_t));
        return py::int_(val);
    });
    ...
    m.def("write_s64", [](int32_t ptr, py::int_ obj){
        ...
        memcpy_rev_to_recomp(t_controller->get_rdram(), ptr, &val, sizeof(int64_t));
    });
    ...
    m.def("read_f32", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        float val;
        memcpy_rev_from_recomp(t_controller->get_rdram(), &val, ptr, sizeof(float));
    ...
    m.def("write_f32", [](int32_t ptr, py::float_ obj){
        ...
        memcpy_rev_to_recomp(t_controller->get_rdram(), ptr, &val, sizeof(float));
    });
    ...
    m.def("read_f64", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        double val;
        memcpy_rev_from_recomp(t_controller->get_rdram(), &val, ptr, sizeof(double));
        return py::float_(val);
    });
    ...
    m.def("write_f64", [](int32_t ptr, py::float_ obj){
        ...
        memcpy_rev_to_recomp(t_controller->get_rdram(), ptr, &val, sizeof(double));
    });
    ...
    m.def("read_char", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        char val;
        memcpy_rev_from_recomp(t_controller->get_rdram(), &val, ptr, sizeof(char));
        return py::str(&val, 1);
    });
    ...
    m.def("write_char", [](int32_t ptr, py::str obj){
        ...
        memcpy_rev_to_recomp(t_controller->get_rdram(), ptr, &val, sizeof(char));
    });
    ...
    m.def("read_str", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        std::u8string str = ptr_to_u8string(t_controller->get_rdram(), ptr);
        return py::str(str);
    });
    ...
    m.def("read_str_n", [](int32_t ptr, uint32_t size){
        ...
        t_controller->thread_check_exception();
        std::u8string str = ptr_to_u8string_n(t_controller->get_rdram(), size, ptr);
        return py::str(str);
    });
    ...
    m.def("write_str_n", [](int32_t ptr, py::str str, uint32_t size){
        ...
        t_controller->thread_check_exception();
        uint8_t* rdram = t_controller->get_rdram(); // Used by MEM_B
    ...
    m.def("read_byte_str", [](int32_t ptr){
        ...
        t_controller->thread_check_exception();
        std::string str = ptr_to_string(t_controller->get_rdram(), ptr);
        return py::bytes(str);
    });
    ...
    m.def("read_byte_str_n", [](int32_t ptr, uint32_t size){
        ...
        t_controller->thread_check_exception();
        std::string str = ptr_to_string_n(t_controller->get_rdram(), size, ptr);
        return py::bytes(str);
    });
    ...
    m.def("read_bytes_n", [](int32_t ptr, uint32_t size, bool reverse) {
        ...
        t_controller->thread_check_exception();
        uint8_t* rdram = t_controller->get_rdram();
...
PYBIND11_EMBEDDED_MODULE(_recomp_mem_raw, m, py::mod_gil_not_used(), py::multiple_interpreters::per_interpreter_gil()) {
    ...
    m.def("create_raw_memoryview", [](int32_t ptr, uint32_t size){
        ...
        t_controller->thread_check_exception();
        void* rptr = RDRAM_TO_PTR(t_controller->get_rdram(), void, ptr);
