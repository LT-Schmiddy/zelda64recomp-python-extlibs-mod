...
class ModProjectConfig:
    ...
    archive_downloads: list[downloads.DownloadArchiveEntry]
    ...
    def set_mips_compiler(self, mips_compiler_path: Path):
        self.mips_compiler_path = mips_compiler_path

    def set_mips_linker(self, mips_linker_path: Path):
        self.mips_linker_path = mips_linker_path
        
    def set_mod_tool(self, mod_tool_path):
        self.mod_tool_path = mod_tool_path

    def add_archive_download(self, url: str, extract_dir: Path):
        self.archive_downloads.append(downloads.DownloadArchiveEntry(url, extract_dir))
        
    def add_mod_toml(self, toml_path: Path, makefile_path: Path):
        self.mod_tomls.append(tomls.ModTomlConfig(toml_path, makefile_path))
